...
## Configuration
The mod is configured using either the in-game config screen, our [online config editor](https://editor.firstdark.dev), or by editing the config file by hand.
...
<Expand title="Default Config File">
